...
ggsave("../plots/startRT_effs_Exp1.png", startRT_effs_plot, width = 8, height = 6)
```
...
# save the plot
ggsave("../plots/ppc_median_startRT_Exp1.png", width = 6, height = 5)
```
...
ggsave("../plots/choiceRT_effs_Exp1.png", choiceRT_effs_plot, width = 8, height = 6)
```
...
# save the plot
ggsave("../plots/ppc_median_choiceRT_Exp1.png", width = 6, height = 5)
```
