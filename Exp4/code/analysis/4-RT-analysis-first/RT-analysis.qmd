---
title: "Experiment 4 - RT analysis (first-phase dataset)"
author: 
  - name: "Zhang Chen"
...
In this set of analyses, I focus on the reaction times of starting game 2 (i.e., start RTs) and those of making a choice in game 2 (i.e., choice RTs). Here I use the dataset from the first phase, with 131 participants.
...
df_exp <- 
  read_csv("../../../data/processed/df_exp_exp4_first.csv")
```
...
# save the figures
ggsave("../plots/startRT_Exp4_first.png", startRT_plot, width = 2.5, height = 5)
ggsave("../plots/startRT_effs_Exp4_first.png", startRT_effs_plot, width = 8, height = 6)
```
...
# save the figures
ggsave("../plots/choiceRT_Exp4_first.png", choiceRT_plot, width = 2.5, height = 5)
ggsave("../plots/choiceRT_effs_Exp4_first.png", choiceRT_effs_plot, width = 8, height = 6)
```
