---
title: "Experiment 2 - RT analysis"
author: 
  - name: "Zhang Chen"
...
df_exp <- 
  read_csv("../../../data/processed/df_exp_exp2.csv")
```
...
# save the figures
ggsave("../plots/startRT_Exp2.png", startRT_plot, width = 2.5, height = 5)
ggsave("../plots/startRT_effs_Exp2.png", startRT_effs_plot, width = 8, height = 6)
```
...
# save the plot
ggsave("../plots/ppc_median_startRT_Exp2.png", width = 6, height = 5)
...
# save the plot
ggsave("../plots/ppc_median_startRT_Exp2_zoomin.png", width = 6, height = 5)
...
# save the figures
ggsave("../plots/choiceRT_Exp2.png", choiceRT_plot, width = 2.5, height = 5)
ggsave("../plots/choiceRT_effs_Exp2.png", choiceRT_effs_plot, width = 8, height = 6)
```
...
# save the plot
ggsave("../plots/ppc_median_choiceRT_Exp2.png", width = 6, height = 5)
```
